...
import { Observable, SubscriptionLike, Subject, Observer, interval, Subscriber } from 'rxjs';
...
export class WebsocketService implements IWebsocketService, OnDestroy {
    ...
    private connection$: Observer<boolean> = new Subscriber<boolean>;
    ...
    public send(event: string, data: any = {}): void {
        if (event && this.isConnected) {
            if (this.websocket$ == null) {
                console.log("send websoket поломан");
            }
            else {
